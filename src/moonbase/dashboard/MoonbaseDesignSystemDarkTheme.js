  ...
  components: {
    ...
    MuiButton: {
      styleOverrides: {
        ...
        textSuccess: {
          ...
          "&:hover": {
            backgroundColor: globalTheme.palette["Success"]["Shades"]["8p"], 
            color: "rgba(100, 207, 111, 1)",  
          }, 
          "&:disabled": {
            border: "1px solid rgba(255, 255, 255, 0.12)", 
        ...
        textInfo: {
          ...
          "&:hover": {
            backgroundColor: globalTheme.palette["Info"]["Shades"]["8p"], 
            color: "rgba(83, 177, 245, 1)",  
          }, 
          "&:disabled": {
            border: "1px solid rgba(255, 255, 255, 0.12)", 
        ...
        textWarning: {
          ...
          "&:hover": {
            backgroundColor: globalTheme.palette["Warning"]["Shades"]["8p"], 
            color: "rgba(245, 161, 83, 1)",  
          }, 
          "&:disabled": {
            border: "1px solid rgba(255, 255, 255, 0.12)", 
    ...
    MuiFormControlLabel: {
      styleOverrides: {
        "label": {
          ...
          "&.Mui-disabled": {
            color: globalTheme.palette["Action"]["Disabled (30p)"], 
            fontStyle: globalTheme.typography["Typography"]["Body 1"].fontStyle, 
            fontFamily: globalTheme.typography["Typography"]["Body 1"].fontFamily, 
            fontWeight: globalTheme.typography["Typography"]["Body 1"].fontWeight, 
            fontSize: globalTheme.typography["Typography"]["Body 1"].fontSize, 
    ...
    MuiSwitch: {
      styleOverrides: {
        root: {
          "&:hover": {
            backgroundColor: globalTheme.palette["Action"]["Hover (8p)"], 
            borderRadius: "100px", 
          }
        },
        thumb: {
