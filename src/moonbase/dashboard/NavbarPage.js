           ...
           <Sec1 >
             <HeroContent >
               <WelcomeRow >
                 ...
                 <Next >
                   <Button variant="contained" size="large" color="primary"  onClick={() => fns.navigate("/moonbase/feedbackbar")} endIcon={ <SvgIcon sx={{width: "18px", height: "22px"}} component = { ArrowForwardFilled1 } />}  > Feedback Component </Button>
                 </Next>
               </WelcomeRow>
             </HeroContent>
           </Sec1>
